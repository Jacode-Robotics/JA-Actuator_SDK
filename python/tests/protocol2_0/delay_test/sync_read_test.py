...
groupSyncWriteable = GroupSyncWrite(portHandler, packetHandler, ADDR_TORQUE_ENABLE, 1)

groupSyncReadable = GroupSyncRead(portHandler, packetHandler, ADDR_TORQUE_ENABLE, 1)
