...
def move_all_joints(goal_position):
    ...
    while 1:
        ...
        for i in range(0, len(DXL_ID)):
            ...
            if not (abs(dxl_goal_position[index] - dxl_present_position) > DXL_MOVING_STATUS_THRESHOLD):
                ...
                # Get Dynamixel present position value
                dxl_present_velocity = groupSyncRead.getData(DXL_ID[i], 576, 4)
...
Enable_all_Dynamixel()

all_Dynamixel_go_home()
...
while 1:
    ...
    move_all_joints(dxl_goal_position[index])
